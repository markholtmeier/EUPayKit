...
2. Enter `https://github.com/mhxdev/EuroPayKit`
...
```swift
let euroPay = EuroPayKit.shared!

do {
    let products = try await euroPay.fetchProducts()
...
```swift
await euroPay.refreshEntitlements(userId: "user_123")

if euroPay.hasAccess(to: "com.myapp.premium") {
